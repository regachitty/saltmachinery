        ...
        <div className="row mt-5">
          ...
          >
            <h2 className="vaccum-text-styles albert-sans text-uppercase pb-4 text-md-start text-center px-4 px-lg-0">
              Oil And Gas Salt Plants
            </h2>
            <p className="vaccum-sub-text-style albert-sans-400 ps-4 text-md-start text-center justify-content-center ">
              Our Oil & Gas Salt Plants are specifically built to produce salt
              used in upstream petroleum operations, including drilling fluids,
              cementing, and enhanced oil recovery. The plants are designed to
              ensure high solubility, purity, and compatibility with critical
        ...
        <div className="row mt-5 p-3">
          ...
          >
            <h2 className="optimised-text-style fw-bold albert-sans pb-2">
              Shriram's Oil And Gas Salt Plants
            </h2>
            <p className="optimised-sub-edge-style albert-sans-400 mb-lg-2 mb-4">
              Shriraam Engineering empowers the oil & gas sector with dependable
              salt plant solutions that support safe, efficient, and
            ...
            {openSections.rawProcessing && (
              <div className="col-12 pt-3">
                <p className="albert-sans-400 pure-head-sub-text-style">
                  High-yield processing for industrial-grade salt
                </p>
                <p className="albert-sans-400 pure-head-sub-text-style">
                  Custom-engineered for oilfield specifications
                </p>
                <p className="albert-sans-400 pure-head-sub-text-style">
                  Scalable plant capacities
                </p>
                <p className="albert-sans-400 pure-head-sub-text-style">
                  Low operational downtime and maintenance
                </p>
              </div>
            )}
            ...
            {openSections.brineRecycling && (
              <div className="col-12 pt-3">
                <p className="albert-sans-400 raw-sub-text-style">
                  Drilling muds and workover fluids
                </p>
                <p className="albert-sans-400 raw-sub-text-style">
                  Well cementing
                </p>
                <p className="albert-sans-400 raw-sub-text-style">
                  Formation stabilization and pressure control
                </p>
              </div>
            )}
            <hr className="my-4 me-3" />
